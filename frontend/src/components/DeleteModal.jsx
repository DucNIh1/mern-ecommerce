  ...
  return (
    <>
      <button
        ...
        className={`text-center disabled:cursor-not-allowed disabled:bg-gray-800 block text-white bg-${color}-700 hover:bg-${color}-800 focus:ring-4 focus:outline-none focus:ring-${color}-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center `}
        type="button"
      >
        {btnText}
      </button>
